        ...
        <div class="col-12">
          <div class="card mt-5 p-2">
            <div class="card-header">
              <h3 class="card-title mt-2">Subscribers</h3>
            </div>
            @if(Session::has('msg'))
              ...
              <div class="table-responsive">
                <table id="example2" class="table table-bordered table-hover w-100">
                  ...
                  <tbody>
                    @if($subscribers)
                      @foreach($subscribers as $key => $subscriber)
                        <tr>
                          <td>{{ $subscribers->currentPage() * $subscribers->perPage() - $subscribers->perPage() + $key + 1 }}</td>
                 ...
                 <div class="d-flex justify-content-end">
                    {{ $subscribers->links('pagination::bootstrap-4') }} <!-- Use Bootstrap 4 pagination -->
                </div>
              </div>
            </div>
            <!-- /.card-body -->
