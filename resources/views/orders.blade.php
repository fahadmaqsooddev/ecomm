            ...
            @foreach($orders as $order)
                <div class="order-card mb-4 p-3 border rounded shadow-sm">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div>
                            <h5>Order #{{ $order->id }} - <small>{{ $order->created_at->format('M d, Y') }}</small></h5>
                        ...
                        <a href="{{ route('getorderdetail',$order->id) }}" class="btn btn-outline-primary btn-sm">
                            View Details
                        </a>
                    </div>
